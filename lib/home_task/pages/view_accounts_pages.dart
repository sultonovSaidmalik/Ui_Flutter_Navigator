...
import 'package:flutter_lesson_22/home_task/pages/view_credit_card_balance.dart';
            ...
            child: Column(
              children: [
                ...
                OutlinedButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(builder: (_) => const ViewCreditCardBalance()));
                  },
                  child: const Text(
                    "Credit Card Balance",
                    style: TextStyle(
