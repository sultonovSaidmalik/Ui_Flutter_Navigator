...
import 'package:flutter_lesson_22/home_task/pages/password_reset_email_sent.dart';
import 'package:flutter_lesson_22/home_task/pages/re-enter_email_address.dart';
                        ...
                        onPressed: () {
                          if (!checkEmail(emailController.text.trim())) {
                            Navigator.of(context).pushReplacement(
                                MaterialPageRoute(
                                    builder: (_) => const EmailAddress()));
                          }else{
                            Navigator.of(context).push(
                                MaterialPageRoute(
                                    builder: (_) => const PasswordResetEmail()));
                          }
                        },
                        child: const Text(
                          "Send temporary\npassword",
